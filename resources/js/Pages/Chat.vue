    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg flex" style="min-height: 400px; max-height: 400px;">
                ...
                <div class="w-3/12 bg-gray-200 bg-opacity-25 border-r border-gray-300 overflow-y-scroll">
                    <ul>
                        <li
                ...
                <div class="w-9/12 flex flex-col justify-between overflow-y-scroll">
                    ...
                    :class="(message.from == page.auth_user.id ? 'text-right' : '')"
                    class="w-full mb-3">
                    ...
                    <div class="w-full p-6 flex flex-col">
                        <div class="w-full mb-3">
                            <p class=" inline-block p-2 rounded-md message-to-me bg-gray-300 bg-opacity-25" style="max-width: 75%;">Oi</p>
                        </div>
                        <span class="block mt-1 text-xs text-gray-500">05/04/2024 08:46</span>
                    </div>
